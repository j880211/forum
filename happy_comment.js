...
function init() {
    ...
    post_btn.addEventListener('click', function () {
        if (post_txt.value != "") {
                firebase.database().ref('happy_list'+ temp.toString()).push({
    ...
    var postdata=firebase.database().ref('happy_list');
    var postsRef = firebase.database().ref('happy_list'+ temp.toString());    
