...
function init() {
    ...
    post_btn.addEventListener('click', function () {
        if (post_txt.value != "") {
                firebase.database().ref('angry_list'+ temp.toString()).push({
    ...
    var postdata=firebase.database().ref('angry_list');
    var postsRef = firebase.database().ref('angry_list'+ temp.toString());    
